...
function ToastItem({ toast, onDismiss }: { toast: ToastMessage; onDismiss: (id: string) => void }) {
  ...
  return (
    <div
      className={`pointer-events-auto flex items-start gap-3 rounded-xl border p-4 shadow-lg animate-slide-in ${bgColors[toast.type]}`}
      role="alert"
      aria-live="polite"
    >
      ...
      <button
        ...
        className="flex-shrink-0 rounded-lg p-1 text-zinc-400 hover:text-zinc-600 hover:bg-zinc-200 transition"
        aria-label="Dismiss"
      >
